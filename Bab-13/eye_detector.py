...
face_cascade = cv2.CascadeClassifier('Bab-13/haar_cascade_files/haarcascade_frontalface_default.xml')
eye_cascade = cv2.CascadeClassifier('Bab-13/haar_cascade_files/haarcascade_eye.xml')
