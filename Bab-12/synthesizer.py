...
if __name__=='__main__':
    ...
    file_tone_single = 'Pak-Faisal/Tugas-AI/AI-Chapter11-16/Bab-12/generated_tone_single.wav'
    file_tone_sequence = 'Pak-Faisal/Tugas-AI/AI-Chapter11-16/Bab-12/generated_tone_sequence.wav'
